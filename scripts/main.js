...
var table = container.querySelector("#myTable");
...
function makeItalic() {
    let paragraphs = document.querySelectorAll(".even");
...
function getTheListItem(num1, num2) {
    let unorderedList = container.querySelectorAll("ul")[num1];
    let listedItem = unorderedList.querySelectorAll("li")[num2];
